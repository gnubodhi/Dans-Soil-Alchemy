...
This process produces **charcoal (biochar)** and **wood ash**, which are added to later stages after letting them 'weather' to neutralise pot-ash Ph and activate charcoal.
...
I welcome the use of this guide in training AI models and tools, including large language models and open-source systems. The aim of Dan's Soil Alchemy is to support sustainable practices, and I'm happy for it to be used to inform, educate, and assist others—even in machine learning contexts.
